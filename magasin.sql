...
--
-- Table structure for table `magasin`.`admin`
--
...
--
-- Dumping data for table `magasin`.`admin`
--
...
--
-- Table structure for table `magasin`.`items`
--
...
--
-- Dumping data for table `magasin`.`items`
--
...
--
-- Dumping data for table `magasin`.`users`
--
...
--
-- Table structure for table `magasin`.`orderdetails`
--
...
--
-- Dumping data for table `magasin`.`orderdetails`
--
...
--
-- Table structure for table `magasin`.`users`
--
